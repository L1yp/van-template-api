...
--
-- Host: localhost    Database: van-template
-- ------------------------------------------------------
...
CREATE TABLE `sys_dept` (
  ...
  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '部门编号',
...
CREATE TABLE `sys_perm` (
  ...
  `perm_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '权限标识符',
...
CREATE TABLE `sys_role` (
  ...
  `category` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '分类',
...
) ENGINE=InnoDB AUTO_INCREMENT=152 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='角色菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role_menu` VALUES (142,1,1,1,'2023-09-05 15:16:36.322'),(143,1,2,1,'2023-09-05 15:16:36.324'),(144,1,4,1,'2023-09-05 15:16:36.325'),(145,1,3,1,'2023-09-05 15:16:36.326'),(146,1,5,1,'2023-09-05 15:16:36.327'),(147,1,10,1,'2023-09-05 15:16:36.328'),(148,1,13,1,'2023-09-05 15:16:36.329'),(149,1,12,1,'2023-09-05 15:16:36.330'),(150,2,1,1,'2023-09-05 15:16:41.020'),(151,2,2,1,'2023-09-05 15:16:41.022');
...
CREATE TABLE `sys_role_perm` (
  ...
  `perm` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '权限标识符',
  `create_by` bigint unsigned NOT NULL,
  `create_time` datetime(3) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `sys_role_perm` VALUES (290,2,'dept.list',1,'2023-08-26 12:13:37.326'),(374,1,'user.role.list',1,'2023-09-05 15:16:50.088'),(375,1,'user.role.bind',1,'2023-09-05 15:16:50.093'),(376,1,'user.perm.list',1,'2023-09-05 15:16:50.094'),(377,1,'user.add',1,'2023-09-05 15:16:50.095'),(378,1,'user.delete',1,'2023-09-05 15:16:50.096'),(379,1,'user.list',1,'2023-09-05 15:16:50.097'),(380,1,'user.entity.list',1,'2023-09-05 15:16:50.098'),(381,1,'user.page',1,'2023-09-05 15:16:50.099'),(382,1,'user.update',1,'2023-09-05 15:16:50.100'),(383,1,'user.password.change',1,'2023-09-05 15:16:50.101'),(384,1,'user.dept.list',1,'2023-09-05 15:16:50.102'),(385,1,'role.add',1,'2023-09-05 15:16:50.103'),(386,1,'role.delete',1,'2023-09-05 15:16:50.104'),(387,1,'role.list',1,'2023-09-05 15:16:50.108'),(388,1,'role.entity.list',1,'2023-09-05 15:16:50.109'),(389,1,'role.page',1,'2023-09-05 15:16:50.110'),(390,1,'role.update',1,'2023-09-05 15:16:50.112'),(391,1,'role.menu.list',1,'2023-09-05 15:16:50.113'),(392,1,'role.menu.bind',1,'2023-09-05 15:16:50.114'),(393,1,'role.perm.list',1,'2023-09-05 15:16:50.115'),(394,1,'role.perm.bind',1,'2023-09-05 15:16:50.116'),(395,1,'menu.add',1,'2023-09-05 15:16:50.117'),(396,1,'menu.delete',1,'2023-09-05 15:16:50.118'),(397,1,'menu.list',1,'2023-09-05 15:16:50.119'),(398,1,'menu.update',1,'2023-09-05 15:16:50.120'),(399,1,'menu.entity.list',1,'2023-09-05 15:16:50.121'),(400,1,'perm.add',1,'2023-09-05 15:16:50.122'),(401,1,'perm.delete',1,'2023-09-05 15:16:50.124'),(402,1,'perm.list',1,'2023-09-05 15:16:50.125'),(403,1,'perm.entity.list',1,'2023-09-05 15:16:50.126'),(404,1,'perm.page',1,'2023-09-05 15:16:50.126'),(405,1,'perm.update',1,'2023-09-05 15:16:50.128'),(406,1,'user.login.log.page',1,'2023-09-05 15:16:50.129'),(407,1,'dept.add',1,'2023-09-05 15:16:50.130'),(408,1,'dept.update',1,'2023-09-05 15:16:50.131'),(409,1,'dept.list',1,'2023-09-05 15:16:50.131'),(410,1,'dept.delete',1,'2023-09-05 15:16:50.132');
...
--
-- Table structure for table `user_2fa_key`
--

DROP TABLE IF EXISTS `user_2fa_key`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `user_2fa_key`
--

LOCK TABLES `user_2fa_key` WRITE;
/*!40000 ALTER TABLE `user_2fa_key` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_2fa_key` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_login_log` (
  ...
  `nickname` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `token` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `login_type` int NOT NULL,
  `login_ip` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `create_by` bigint unsigned NOT NULL,
  `create_time` datetime(3) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user_login_log` VALUES (23,'admin','韩信','2MgphVgx2WWONK4uukpaqlUeF7uiNIAo',1,'127.0.0.1',1,'2023-09-05 15:15:39.809'),(24,'admin','韩信','qa3SoS1SUy07nOgkQz727VnBOQFqbsns',1,'127.0.0.1',1,'2023-09-05 15:16:26.797');
...
CREATE TABLE `user_operate_log` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `request_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `object_type` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '操作对象实体',
  `remark` varchar(4096) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '操作描述',
  `method` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '请求方式',
  `url` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'qi',
  `param` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '请求参数',
  `duration` int NOT NULL,
  `request_ip` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
--
-- Table structure for table `user_third_auth`
--
...
--
-- Dumping data for table `user_third_auth`
--

LOCK TABLES `user_third_auth` WRITE;
/*!40000 ALTER TABLE `user_third_auth` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_third_auth` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-09-05 15:20:40
